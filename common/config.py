...
class ConfigKey(object):
    ...
    BK_TEMPLATE_CATEGORY_IDS = "BK_TEMPLATE_CATEGORY_IDS"
    BK_TEMPLATE_INFD_VALUES = "BK_TEMPLATE_INFD_VALUES"
    BK_TEMPLATE_INBK_VALUES = "BK_TEMPLATE_INBK_VALUES"
    BK_TEMPLATE_STATUS = "BK_TEMPLATE_STATUS"
    BK_TEMPLATE_FUNC = "BK_TEMPLATE_FUNC"
