...
export default {
  ...
  actions: {
    loadSupLogs ({commit}, params) {
      ...
      let url = BASE_URL + '/api/sup/suplogs/?page=' + params.page
      if (params.keys) {
    ...
    createSuplog ({commit, rootState}, suplog) {
      return new Promise((resolve, reject) => {
        ...
        axios.post(BASE_URL + '/api/sup/suplogs/', suplog, {
    ...
    deleteSupLog ({commit, rootState}, id) {
      return new Promise((resolve, reject) => {
        ...
        axios.delete(BASE_URL + '/api/sup/suplogs/' + id + '/', {
          headers: { 'X-Authorization': 'JWT ' + getAccessToken(),
            'X-CSRFToken': rootState.constants.csrToken
          }})
          .then(response => {
    ...
    updateSuplog ({commit, rootState}, suplog) {
      console.log('>>>update suplog....' + suplog.id)
      return new Promise((resolve, reject) => {
        axios.put(BASE_URL + '/api/sup/suplogs/' + suplog.id + '/', suplog, {
          headers: { 'X-Authorization': 'JWT ' + getAccessToken(),
            'X-CSRFToken': rootState.constants.csrToken
          }})
          .then(response => {
